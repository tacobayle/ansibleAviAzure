...
if len([*data_loaded['all']['children']['controller']['hosts']]) == 1:
  avi_credentials = { 'avi_credentials': {'controller' : controllerLeader, 'username': username, 'api_version': version}, 'avi_cluster': False}
if len([*data_loaded['all']['children']['controller']['hosts']]) == 3:
  ...
  avi_credentials = { 'avi_credentials': {'controller' : controllerLeader, 'username': username, 'api_version': version}, 'avi_cluster': {'name': 'avi-cluster', 'ip': controllerFollower }}
